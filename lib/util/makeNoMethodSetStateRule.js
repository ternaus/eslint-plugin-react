...
function shouldBeNoop(methodName) {
  return methodName === 'componentDidMount' || methodName === 'componentDidUpdate';
}
 ...
 */
const exported = function makeNoMethodSetStateRule(methodName, shouldCheckUnsafeCb) {
  return {
    meta: {
      docs: {
