...
function getFromContext(context) {
  ...
  const comments = typeof sourceCode.getAllComments === 'function' ? sourceCode.getAllComments() : [];
  const pragmaNode = comments.find((node) => JSX_ANNOTATION_REGEX.test(node.value));
