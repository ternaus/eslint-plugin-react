...
function getDeprecated(pragma) {
  ...
  deprecated['ReactDOM.render'] = ['18.0.0', 'createRoot', 'https://reactjs.org/link/switch-to-createroot'];
  deprecated['ReactDOM.hydrate'] = ['18.0.0', 'hydrateRoot', 'https://reactjs.org/link/switch-to-createroot'];
...
const exported = {
  ...
  create(context) {
    ...
    function isDeprecated(method) {
      return Boolean(deprecated && deprecated[method] && deprecated[method][0]);
    }
    ...
    return {
      ...
      ImportDeclaration(node) {
        ...
        node.specifiers
          ...
          .forEach((specifier) => {
            // ESTree import specifiers may omit an imported identifier for side-effect imports.
            checkDeprecation(
              node,
