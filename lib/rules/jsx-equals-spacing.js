    ...
    return {
      JSXOpeningElement(node) {
        node.attributes.forEach((attrNode) => {
          ...
          const spacedBefore = eslintUtil.isSpaceBetweenTokens(sourceCode, attrNode.name, equalToken);
          const spacedAfter = eslintUtil.isSpaceBetweenTokens(sourceCode, equalToken, attrNode.value);
