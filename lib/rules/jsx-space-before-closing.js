  ...
  create(context) {
    ...
    return {
      JSXOpeningElement(node) {
        ...
        if (configuration === 'always' && !eslintUtil.isSpaceBetweenTokens(sourceCode, leftToken, closingSlash)) {
        ...
        } else if (configuration === 'never' && eslintUtil.isSpaceBetweenTokens(sourceCode, leftToken, closingSlash)) {
