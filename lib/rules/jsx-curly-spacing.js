...
const exported = {
  ...
  create(context) {
    ...
    function validateBraceSpacing(node) {
      ...
      if (spacing === SPACING.always) {
        if (!eslintUtil.isSpaceBetweenTokens(sourceCode, first, second)) {
          reportRequiredBeginningSpace(node, first);
        } else if (!config.allowMultiline && isMultiline(first, second)) {
          reportNoBeginningNewline(node, first, spacing);
        }
        if (!eslintUtil.isSpaceBetweenTokens(sourceCode, penultimate, last)) {
        ...
        } else if (eslintUtil.isSpaceBetweenTokens(sourceCode, first, second)) {
        ...
        } else if (eslintUtil.isSpaceBetweenTokens(sourceCode, penultimate, last)) {
